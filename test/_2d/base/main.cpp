...
TEST(IDWInterp, Base) {
    ...
    auto interp = ni::make_i<ni::_2d::Type2DScat::IDW>(xp, yp, zp);
...
TEST(NNInterp, Base) {
    ...
    auto interp = ni::make_i<ni::_2d::Type2DScat::NearestNeighbour>(xp, yp, zp);
    const auto z = interp(x, y);
...
TEST(TINInterp, Base) {
    ...
    auto interp = ni::make_i<ni::_2d::Type2DScat::TIN>(xp, yp, zp);
    const auto z = interp(x, y);
    ASSERT_TRUE(arrays_eq(z, expected));
}
...
TEST(RBFInterp, Linear) {
    const std::vector<double> xp{4, 1, 5, 2, 3}, yp{5, 2, 6, 3, 4}, zp{40, 10, 50, 20, 30}, x{2.5, 3, 5}, y{3.5, 4, 5},
            expected{25, 30, 43.63636};
    auto interp = ni::make_i<ni::_2d::Type2DRBF::Linear>(xp, yp, zp);
    const auto z = interp(x, y);
    print(z);
//    ASSERT_TRUE(arrays_eq(z, expected));
}
...
TEST(RBFInterp, Cubic) {
    const std::vector<double> xp{4, 1, 5, 2, 3}, yp{5, 2, 6, 3, 4}, zp{40, 10, 50, 20, 30}, x{2.5, 3, 5}, y{3.5, 4, 5},
            expected{25, 30, 43.63636};
    auto interp = ni::make_i<ni::_2d::Type2DRBF::Cubic>(xp, yp, zp);
    const auto z = interp(x, y);
    print(z);
//    ASSERT_TRUE(arrays_eq(z, expected));
}
...
TEST(RBFInterp, Quintic) {
    const std::vector<double> xp{4, 1, 5, 2, 3}, yp{5, 2, 6, 3, 4}, zp{40, 10, 50, 20, 30}, x{2.5, 3, 5}, y{3.5, 4, 5},
            expected{25, 30, 43.63636};
    auto interp = ni::make_i<ni::_2d::Type2DRBF::Quintic>(xp, yp, zp);
    const auto z = interp(x, y);
    print(z);
//    ASSERT_TRUE(arrays_eq(z, expected));
}
...
TEST(RBFInterp, Multiquadric) {
    const std::vector<double> xp{4, 1, 5, 2, 3}, yp{5, 2, 6, 3, 4}, zp{40, 10, 50, 20, 30}, x{2.5, 3, 5}, y{3.5, 4, 5},
            expected{25, 30, 43.63636};
    auto interp = ni::make_i<ni::_2d::Type2DRBF::Multiquadric>(xp, yp, zp);
    const auto z = interp(x, y);
    print(z);
//    ASSERT_TRUE(arrays_eq(z, expected));
}
...
TEST(RBFInterp, InverseMultiquadric) {
    const std::vector<double> xp{4, 1, 5, 2, 3}, yp{5, 2, 6, 3, 4}, zp{40, 10, 50, 20, 30}, x{2.5, 3, 5}, y{3.5, 4, 5},
            expected{25, 30, 43.63636};
    auto interp = ni::make_i<ni::_2d::Type2DRBF::InverseMultiquadric>(xp, yp, zp);
    const auto z = interp(x, y);
    print(z);
//    ASSERT_TRUE(arrays_eq(z, expected));
}
...
TEST(RBFInterp, Gaussian) {
    const std::vector<double> xp{4, 1, 5, 2, 3}, yp{5, 2, 6, 3, 4}, zp{40, 10, 50, 20, 30}, x{2.5, 3, 5}, y{3.5, 4, 5},
            expected{25, 30, 43.63636};
    auto interp = ni::make_i<ni::_2d::Type2DRBF::Gaussian>(xp, yp, zp);
    const auto z = interp(x, y);
    print(z);
//    ASSERT_TRUE(arrays_eq(z, expected));
}
...
TEST(RBFInterp, ThinPlate) {
    const std::vector<double> xp{4, 1, 5, 2, 3}, yp{5, 2, 6, 3, 4}, zp{40, 10, 50, 20, 30}, x{2.5, 3, 5}, y{3.5, 4, 5},
            expected{25, 30, 43.63636};
    auto interp = ni::make_i<ni::_2d::Type2DRBF::ThinPlate>(xp, yp, zp);
    const auto z = interp(x, y);
    print(z);
//    ASSERT_TRUE(arrays_eq(z, expected));
}
...
TEST(Interp2D, Traits) {
    using type = std::invoke_result_t<decltype(ni::make_i<ni::_2d::Type2DScat::IDW,
